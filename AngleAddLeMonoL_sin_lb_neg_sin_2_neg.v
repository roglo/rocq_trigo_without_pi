...
move H23 at bottom.
apply (rngl_leb_gt_iff Hor) in Hzs12, Hzs2.
rewrite Hzs12.
rewrite Hzs2 in H23.
apply (rngl_leb_gt_iff Hor) in Hzs12, Hzs2.
destruct zs3; [ easy | ].
...
destruct zs13. {
  ...
  clear - Hzs13 Hor θ2 H23 Hzs12 Hzs2 Heo Hop Hzs3 Hon Hs13 Hc1 Hos Hiq.
...
assert (Haov12 : angle_add_overflow θ1 θ2 = false). {
  ...
  progress unfold angle_leb.
  apply (rngl_leb_gt_iff Hor) in Hzs2, Hzs3.
  rewrite Hzs2, Hzs3.
